...
BOT_TOKEN = os.getenv("BOT_TOKEN", "8479229761:AAGbmY8k5MSngcGSulo6VZ5rWzrikwgtOUw")
CODART_TOKEN = os.getenv("CODART_TOKEN", "mOcE4wlqIGe9aN15hnZitQPzGKqEvR9L3n6hzB6opa7J8BNk1n8cgw5JOOIF")
...
async def facial_command(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        ...
        if not rostros:
            await update.message.reply_text("❌ No se detectó ningún rostro." + footer_creditos(context))
            return
...
def main():
    ...
    print("🚀 Servidor de pagos activo — /webhook-pago")
    ...
    print("🤖 Bot SPECTER PERÚ iniciado")
